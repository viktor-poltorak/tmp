...
$_['You_are_here'] = 'Вы здесь';
$_['Home'] = 'Главная';
$_['about_us'] = 'О компании';
$_['Catalog'] = 'Каталог';
$_['News'] = 'Новости';
$_['Contacts'] = 'Контакты';
$_['Services'] = 'Услуги';
$_['Sitemap'] = 'Карта сайта';
$_['Share'] = 'Поделиться';
$_['Print'] = 'Распечатать';
$_['copyright'] = 'Все права защищены (С) «Специальные материалы»';
$_['Materials_for_Industry'] = 'Материалы для отрасли';
$_['Course_of_sales_of_non_ferrous_metals'] = 'Курс продаж цветных металлов';