...
Host - 5.1.61-0ubuntu0.10.10.1 : Database - smsu
*********************************************************************
...
/*Data for the table `_affiliate_transaction` */
...
/*Data for the table `_attribute` */

insert  into `_attribute`(`attribute_id`,`attribute_group_id`,`sort_order`) values (12,7,1);
...
/*Data for the table `_attribute_description` */

insert  into `_attribute_description`(`attribute_id`,`language_id`,`name`) values (12,1,'Применение'),(12,2,'Применение');
...
/*Data for the table `_attribute_group` */

insert  into `_attribute_group`(`attribute_group_id`,`sort_order`) values (7,1);
...
/*Data for the table `_attribute_group_description` */

insert  into `_attribute_group_description`(`attribute_group_id`,`language_id`,`name`) values (7,2,'Продукт'),(7,1,'Продукт');
...
/*Data for the table `_banner` */

insert  into `_banner`(`banner_id`,`name`,`status`) values (6,'HP Products',1),(7,'Samsung Tab',1),(8,'Manufacturers',1);
...
/*Data for the table `_banner_image_description` */

insert  into `_banner_image_description`(`banner_image_id`,`language_id`,`banner_id`,`title`) values (54,1,7,'Samsung Tab 10.1'),(77,1,6,'HP Banner'),(75,1,8,'HTC'),(74,1,8,'Canon'),(73,1,8,'Apple'),(72,1,8,'Palm'),(71,1,8,'Sony'),(76,1,8,'Hewlett-Packard'),(54,2,7,'Samsung Tab 10.1'),(77,2,6,'HP Banner'),(75,2,8,'HTC'),(74,2,8,'Canon'),(73,2,8,'Apple'),(72,2,8,'Palm'),(71,2,8,'Sony'),(76,2,8,'Hewlett-Packard');
...
/*Data for the table `_category_to_layout` */
...
/*Data for the table `_category_to_store` */

insert  into `_category_to_store`(`category_id`,`store_id`) values (59,0),(60,0),(61,0),(62,0),(63,0),(64,0),(65,0),(66,0),(67,0),(68,0);
...
/*Data for the table `_coupon_history` */
...
/*Data for the table `_coupon_product` */
...
/*Data for the table `_currency` */

insert  into `_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (1,'Pound Sterling','GBP','£','','2',0.62150002,1,'2012-04-23 14:21:31'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2012-04-24 14:07:08'),(3,'Euro','EUR','','€','2',0.76289999,1,'2012-04-23 14:21:31');
...
/*Data for the table `_customer_group` */

insert  into `_customer_group`(`customer_group_id`,`name`) values (8,'Default'),(6,'Wholesale');
...
/*Data for the table `_customer_ip` */
...
/*Data for the table `_customer_reward` */
...
/*Data for the table `_customer_transaction` */
...
/*Data for the table `_download_description` */

insert  into `_download_description`(`download_id`,`language_id`,`name`) values (1,2,'file'),(1,1,'file'),(2,2,'прайс-лист'),(2,1,'прайс-лист'),(3,2,'GRILLO'),(3,1,'GRILLO');
...
/*Data for the table `_extension` */

insert  into `_extension`(`extension_id`,`type`,`code`) values (22,'total','shipping'),(57,'total','sub_total'),(58,'total','tax'),(59,'total','total'),(410,'module','banner'),(426,'module','carousel'),(390,'total','credit'),(349,'total','handling'),(350,'total','low_order_fee'),(389,'total','coupon'),(413,'module','category'),(430,'module','latest'),(393,'total','reward'),(398,'total','voucher'),(432,'module','news'),(428,'module','featured'),(419,'module','slideshow'),(431,'module','special');
...
/*Data for the table `_geo_zone` */

insert  into `_geo_zone`(`geo_zone_id`,`name`,`description`,`date_modified`,`date_added`) values (3,'UK VAT Zone','UK VAT','2010-02-26 22:33:24','2009-01-06 23:26:25'),(4,'UK Shipping','UK Shipping Zones','2010-12-15 15:18:13','2009-06-23 01:14:53');
...
/*Data for the table `_information` */

insert  into `_information`(`information_id`,`sort_order`,`status`) values (3,3,1),(4,1,1),(5,4,1),(6,2,1);
...
/*Data for the table `_information_to_layout` */
...
/*Data for the table `_information_to_store` */

insert  into `_information_to_store`(`information_id`,`store_id`) values (3,0),(4,0),(5,0),(6,0);
...
insert  into `_language`(`language_id`,`name`,`code`,`locale`,`image`,`directory`,`filename`,`sort_order`,`status`) values (1,'English','en','en_US.UTF-8,en_US,en-gb,english','gb.png','english','english',0,1),(2,'Russian','ru','ru_RU.UTF-8,ru_RU,ru-rus,russian','ru.png','russian','russian',0,1);
...
/*Data for the table `_layout` */

insert  into `_layout`(`layout_id`,`name`) values (1,'Home'),(2,'Product'),(3,'Category'),(4,'Default'),(5,'Manufacturer'),(6,'Account'),(7,'Checkout'),(8,'Contact'),(9,'Sitemap'),(10,'Affiliate'),(11,'Information');
...
/*Data for the table `_layout_route` */

insert  into `_layout_route`(`layout_route_id`,`layout_id`,`store_id`,`route`) values (30,6,0,'account'),(17,10,0,'affiliate/'),(29,3,0,'product/category'),(27,1,3,'common/home'),(26,1,0,'common/home'),(20,2,0,'product/product'),(24,11,0,'information/information'),(22,5,0,'product/manufacturer'),(23,7,0,'checkout/'),(31,8,0,'information/contact');
...
/*Data for the table `_length_class` */

insert  into `_length_class`(`length_class_id`,`value`) values (1,'1.00000000'),(2,'10.00000000'),(3,'0.39370000');
...
/*Data for the table `_length_class_description` */

insert  into `_length_class_description`(`length_class_id`,`language_id`,`title`,`unit`) values (1,1,'Centimeter','cm'),(2,1,'Millimeter','mm'),(3,1,'Inch','in'),(1,2,'Centimeter','cm'),(2,2,'Millimeter','mm'),(3,2,'Inch','in');
...
/*Data for the table `_manufacturer` */
...
/*Data for the table `_manufacturer_to_store` */
...
/*Data for the table `_news` */

insert  into `_news`(`news_id`,`status`,`image`,`image_size`,`date_added`) values (1,1,'',0,'2012-02-21 11:15:52'),(2,1,'',0,'2012-02-21 14:57:58'),(3,1,'',0,'2012-02-21 14:58:08'),(4,1,'',0,'2012-02-21 14:58:22');
...
/*Data for the table `_news_to_store` */

insert  into `_news_to_store`(`news_id`,`store_id`) values (1,0),(2,0),(3,0),(4,0);
...
/*Data for the table `_option_description` */
...
/*Data for the table `_option_value` */
...
/*Data for the table `_option_value_description` */
...
/*Data for the table `_order_download` */
...
/*Data for the table `_order_history` */
...
/*Data for the table `_order_option` */
...
/*Data for the table `_order_product` */
...
/*Data for the table `_order_total` */
...
/*Data for the table `_product` */

insert  into `_product`(`product_id`,`model`,`sku`,`upc`,`location`,`quantity`,`stock_status_id`,`image`,`manufacturer_id`,`shipping`,`price`,`points`,`tax_class_id`,`date_available`,`weight`,`weight_class_id`,`length`,`width`,`height`,`length_class_id`,`subtract`,`minimum`,`sort_order`,`status`,`date_added`,`date_modified`,`viewed`) values (56,'1','','','',1,5,'data/1_1.jpg',0,1,'0.0000',0,0,'2012-02-23','0.00',1,'0.00','0.00','0.00',1,1,1,1,1,'2012-02-24 14:04:17','0000-00-00 00:00:00',35),(57,'2','','','',1,5,'data/1_2.jpg',0,1,'0.0000',0,0,'2012-02-23','0.00',1,'0.00','0.00','0.00',1,1,1,1,1,'2012-02-24 14:05:00','2012-02-24 14:13:49',39),(58,'3','','','',1,5,'data/1_3.jpg',0,1,'0.0000',0,0,'2012-02-23','0.00',1,'0.00','0.00','0.00',1,1,1,1,1,'2012-02-24 14:05:32','2012-02-24 14:14:11',39),(59,'4','','','',1,5,'data/1_4.jpg',0,1,'0.0000',0,0,'2012-02-23','0.00',1,'0.00','0.00','0.00',1,1,1,1,1,'2012-02-24 14:06:14','2012-02-24 14:13:41',32),(60,'5','','','',1,5,'data/1_5.jpg',0,1,'0.0000',0,0,'2012-02-23','0.00',1,'0.00','0.00','0.00',1,1,1,1,1,'2012-02-24 14:11:13','2012-02-24 14:14:03',33),(61,'6','','','',1,5,'data/1_6.jpg',0,1,'0.0000',0,0,'2012-02-23','0.00',1,'0.00','0.00','0.00',1,1,1,1,1,'2012-02-24 14:12:12','2012-04-24 16:53:56',73),(62,'7','','','',1,5,'data/1_7.jpg',0,1,'0.0000',0,0,'2012-02-23','0.00',1,'0.00','0.00','0.00',1,1,1,1,1,'2012-02-24 14:13:04','0000-00-00 00:00:00',32);
...
/*Data for the table `_product_discount` */
...
/*Data for the table `_product_image` */

insert  into `_product_image`(`product_image_id`,`product_id`,`image`,`sort_order`) values (2424,61,'data/image1.png',0),(2425,61,'data/image2.png',0);
...
/*Data for the table `_product_option` */
...
/*Data for the table `_product_option_value` */
...
/*Data for the table `_product_related` */
...
) ENGINE=MyISAM AUTO_INCREMENT=661 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

/*Data for the table `_product_reward` */

insert  into `_product_reward`(`product_reward_id`,`product_id`,`customer_group_id`,`points`) values (634,57,6,0),(633,57,8,0),(638,58,6,0),(637,58,8,0),(660,61,6,0),(659,61,8,0),(636,60,6,0),(635,60,8,0),(632,59,6,0),(631,59,8,0),(616,56,6,0),(615,56,8,0),(627,62,8,0),(628,62,6,0);
...
/*Data for the table `_product_special` */
...
/*Data for the table `_product_tag` */
...
/*Data for the table `_product_to_category` */

insert  into `_product_to_category`(`product_id`,`category_id`) values (56,59),(57,59),(58,59),(59,59),(60,59),(61,59),(61,64),(62,59);
...
/*Data for the table `_product_to_download` */

insert  into `_product_to_download`(`product_id`,`download_id`) values (61,3);
...
/*Data for the table `_product_to_layout` */
...
/*Data for the table `_product_to_store` */

insert  into `_product_to_store`(`product_id`,`store_id`) values (56,0),(57,0),(58,0),(59,0),(60,0),(61,0),(62,0);
...
/*Data for the table `_return_action` */

insert  into `_return_action`(`return_action_id`,`language_id`,`name`) values (1,1,'Refunded'),(2,1,'Credit Issued'),(3,1,'Replacement Sent'),(1,2,'Refunded'),(2,2,'Credit Issued'),(3,2,'Replacement Sent');
...
/*Data for the table `_return_history` */
...
/*Data for the table `_return_product` */
...
/*Data for the table `_return_status` */

insert  into `_return_status`(`return_status_id`,`language_id`,`name`) values (1,1,'Pending'),(3,1,'Complete'),(2,1,'Awaiting Products'),(1,2,'Pending'),(3,2,'Complete'),(2,2,'Awaiting Products');
...
) ENGINE=MyISAM AUTO_INCREMENT=25747 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

/*Data for the table `_setting` */

insert  into `_setting`(`setting_id`,`store_id`,`group`,`key`,`value`,`serialized`) values (9457,0,'shipping','shipping_sort_order','3',0),(3453,0,'sub_total','sub_total_sort_order','1',0),(3452,0,'sub_total','sub_total_status','1',0),(272,0,'tax','tax_status','1',0),(16013,0,'total','total_sort_order','9',0),(16012,0,'total','total_status','1',0),(273,0,'tax','tax_sort_order','5',0),(25724,0,'config','config_image_wishlist_width','50',0),(25723,0,'config','config_image_compare_height','90',0),(24383,0,'news','news_thumb_height','100',0),(9456,0,'shipping','shipping_status','1',0),(9455,0,'shipping','shipping_estimator','1',0),(25722,0,'config','config_image_compare_width','90',0),(25721,0,'config','config_image_related_height','150',0),(25720,0,'config','config_image_related_width','150',0),(13801,0,'coupon','coupon_sort_order','4',0),(13800,0,'coupon','coupon_status','1',0),(25719,0,'config','config_image_additional_height','144',0),(25718,0,'config','config_image_additional_width','225',0),(24372,0,'carousel','carousel_module','a:1:{i:0;a:9:{s:9:\"banner_id\";s:1:\"7\";s:5:\"limit\";s:1:\"5\";s:6:\"scroll\";s:1:\"3\";s:5:\"width\";s:2:\"80\";s:6:\"height\";s:2:\"80\";s:9:\"layout_id\";s:1:\"1\";s:8:\"position\";s:14:\"content_bottom\";s:6:\"status\";s:1:\"1\";s:10:\"sort_order\";s:2:\"-1\";}}',1),(24384,0,'news','news_popup_width','1024',0),(24385,0,'news','news_popup_height','768',0),(24386,0,'news','news_module','a:1:{i:0;a:7:{s:5:\"limit\";s:1:\"3\";s:9:\"layout_id\";s:1:\"6\";s:8:\"position\";s:11:\"column_left\";s:6:\"status\";s:1:\"1\";s:8:\"headline\";s:1:\"1\";s:8:\"numchars\";s:3:\"200\";s:10:\"sort_order\";s:0:\"\";}}',1),(9444,0,'credit','credit_sort_order','7',0),(9443,0,'credit','credit_status','1',0),(25717,0,'config','config_image_product_height','150',0),(25716,0,'config','config_image_product_width','150',0),(25715,0,'config','config_image_popup_height','728',0),(25714,0,'config','config_image_popup_width','1024',0),(18432,0,'reward','reward_sort_order','2',0),(18431,0,'reward','reward_status','1',0),(25713,0,'config','config_image_thumb_height','230',0),(25712,0,'config','config_image_thumb_width','230',0),(19927,0,'category','category_module','a:2:{i:0;a:4:{s:9:\"layout_id\";s:1:\"3\";s:8:\"position\";s:11:\"column_left\";s:6:\"status\";s:1:\"1\";s:10:\"sort_order\";s:1:\"1\";}i:1;a:4:{s:9:\"layout_id\";s:1:\"2\";s:8:\"position\";s:11:\"column_left\";s:6:\"status\";s:1:\"1\";s:10:\"sort_order\";s:1:\"1\";}}',1),(25711,0,'config','config_image_category_height','100',0),(25710,0,'config','config_image_category_width','150',0),(25709,0,'config','config_icon','data/cart.png',0),(25708,0,'config','config_logo','data/logo.png',0),(25707,0,'config','config_cart_weight','1',0),(25706,0,'config','config_upload_allowed','jpg, JPG, jpeg, gif, png, txt',0),(25705,0,'config','config_download','1',0),(25704,0,'config','config_review_status','1',0),(25703,0,'config','config_return_status_id','2',0),(25702,0,'config','config_complete_status_id','5',0),(25701,0,'config','config_order_status_id','1',0),(25700,0,'config','config_stock_status_id','5',0),(25699,0,'config','config_stock_checkout','0',0),(25698,0,'config','config_stock_warning','0',0),(25697,0,'config','config_stock_display','0',0),(25696,0,'config','config_commission','5',0),(25695,0,'config','config_affiliate_id','4',0),(16017,0,'voucher','voucher_sort_order','8',0),(16016,0,'voucher','voucher_status','1',0),(25694,0,'config','config_checkout_id','5',0),(25693,0,'config','config_account_id','3',0),(25692,0,'config','config_guest_checkout','1',0),(24382,0,'news','news_thumb_width','100',0),(24381,0,'news','news_headline_chars','200',0),(25691,0,'config','config_customer_approval','0',0),(25690,0,'config','config_customer_price','0',0),(24387,0,'slideshow','slideshow_module','a:1:{i:0;a:7:{s:9:\"banner_id\";s:1:\"6\";s:5:\"width\";s:3:\"535\";s:6:\"height\";s:3:\"375\";s:9:\"layout_id\";s:1:\"1\";s:8:\"position\";s:11:\"content_top\";s:6:\"status\";s:1:\"1\";s:10:\"sort_order\";s:1:\"1\";}}',1),(20030,0,'banner','banner_module','a:1:{i:0;a:7:{s:9:\"banner_id\";s:1:\"6\";s:5:\"width\";s:3:\"182\";s:6:\"height\";s:3:\"182\";s:9:\"layout_id\";s:1:\"3\";s:8:\"position\";s:11:\"column_left\";s:6:\"status\";s:1:\"1\";s:10:\"sort_order\";s:1:\"3\";}}',1),(25689,0,'config','config_customer_group_id','8',0),(25688,0,'config','config_invoice_prefix','INV-2011-00',0),(25687,0,'config','config_tax_customer','shipping',0),(25686,0,'config','config_tax_default','shipping',0),(25685,0,'config','config_tax','1',0),(25684,0,'config','config_admin_limit','20',0),(25683,0,'config','config_catalog_limit','15',0),(25682,0,'config','config_weight_class_id','1',0),(25681,0,'config','config_length_class_id','1',0),(25680,0,'config','config_currency_auto','1',0),(25679,0,'config','config_currency','USD',0),(25678,0,'config','config_admin_language','ru',0),(25677,0,'config','config_language','ru',0),(25676,0,'config','config_zone_id','3563',0),(25675,0,'config','config_country_id','222',0),(25674,0,'config','config_layout_id','4',0),(25673,0,'config','config_template','default',0),(25672,0,'config','config_meta_description','Special Materials',0),(25671,0,'config','config_title','Special Materials',0),(25670,0,'config','config_skype','special-materials',0),(25669,0,'config','config_fax','+7 499 504 04 47',0),(25668,0,'config','config_telephone','+7 499 504 04 46',0),(25667,0,'config','config_email','info@special-materials.com',0),(25666,0,'config','config_address','Address 1',0),(25665,0,'config','config_owner','Special Materials',0),(25664,0,'config','config_name','Special Materials',0),(25725,0,'config','config_image_wishlist_height','50',0),(25726,0,'config','config_image_cart_width','150',0),(25727,0,'config','config_image_cart_height','150',0),(25728,0,'config','config_mail_protocol','mail',0),(25729,0,'config','config_mail_parameter','',0),(25730,0,'config','config_smtp_host','',0),(25731,0,'config','config_smtp_username','',0),(25732,0,'config','config_smtp_password','',0),(25733,0,'config','config_smtp_port','25',0),(25734,0,'config','config_smtp_timeout','5',0),(25735,0,'config','config_alert_mail','0',0),(25736,0,'config','config_account_mail','0',0),(25737,0,'config','config_alert_emails','',0),(25738,0,'config','config_use_ssl','0',0),(25739,0,'config','config_seo_url','0',0),(25740,0,'config','config_maintenance','0',0),(25741,0,'config','config_encryption','12345',0),(25742,0,'config','config_compression','0',0),(25743,0,'config','config_error_display','1',0),(25744,0,'config','config_error_log','1',0),(25745,0,'config','config_error_filename','error.txt',0),(25746,0,'config','config_google_analytics','',0);
...
/*Data for the table `_stock_status` */

insert  into `_stock_status`(`stock_status_id`,`language_id`,`name`) values (7,1,'In Stock'),(8,1,'Pre-Order'),(5,1,'Out Of Stock'),(6,1,'2 - 3 Days'),(7,2,'In Stock'),(8,2,'Pre-Order'),(5,2,'Out Of Stock'),(6,2,'2 - 3 Days');
...
/*Data for the table `_tax_class` */

insert  into `_tax_class`(`tax_class_id`,`title`,`description`,`date_added`,`date_modified`) values (9,'Taxable Goods','Taxed Stuff','2009-01-06 23:21:53','2011-09-23 14:07:50'),(10,'Downloadable Products','Downloadable','2011-09-21 22:19:39','2011-09-22 10:27:36');
...
/*Data for the table `_tax_rate` */

insert  into `_tax_rate`(`tax_rate_id`,`geo_zone_id`,`name`,`rate`,`type`,`date_added`,`date_modified`) values (86,3,'VAT (17.5%)','17.5000','P','2011-03-09 21:17:10','2011-09-22 22:24:29'),(87,3,'Eco Tax (-2.00)','2.0000','F','2011-09-21 21:49:23','2011-09-23 00:40:19');
...
/*Data for the table `_tax_rate_to_customer_group` */

insert  into `_tax_rate_to_customer_group`(`tax_rate_id`,`customer_group_id`) values (86,6),(86,8),(87,6),(87,8);
...
/*Data for the table `_tax_rule` */

insert  into `_tax_rule`(`tax_rule_id`,`tax_class_id`,`tax_rate_id`,`based`,`priority`) values (121,10,86,'payment',1),(120,10,87,'store',0),(128,9,86,'shipping',1),(127,9,87,'shipping',2);
...
) ENGINE=MyISAM AUTO_INCREMENT=787 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

/*Data for the table `_url_alias` */

insert  into `_url_alias`(`url_alias_id`,`query`,`keyword`) values (785,'category_id=59','Цинк и цинковые сплавы'),(778,'news_id=1','ПАСЕ 25 января приняла резолюцию'),(776,'information_id=4','О компании'),(786,'category_id=60','Медные сплавы');
...
insert  into `_user`(`user_id`,`user_group_id`,`username`,`password`,`firstname`,`lastname`,`email`,`code`,`ip`,`status`,`date_added`) values (1,1,'admin','21232f297a57a5a743894a0e4a801fc3','','','info@special-materials.com','','127.0.0.1',1,'2012-02-20 11:45:10');
...
/*Data for the table `_voucher_history` */
...
/*Data for the table `_voucher_theme` */

insert  into `_voucher_theme`(`voucher_theme_id`,`image`) values (8,'data/canon_eos_5d_2.jpg'),(7,'data/gift-voucher-birthday.jpg'),(6,'data/apple_logo.jpg');
...
/*Data for the table `_voucher_theme_description` */

insert  into `_voucher_theme_description`(`voucher_theme_id`,`language_id`,`name`) values (6,1,'Christmas'),(7,1,'Birthday'),(8,1,'General'),(6,2,'Christmas'),(7,2,'Birthday'),(8,2,'General');
...
/*Data for the table `_weight_class` */

insert  into `_weight_class`(`weight_class_id`,`value`) values (1,'1.00000000'),(2,'1000.00000000'),(5,'2.20460000'),(6,'35.27400000');
...
/*Data for the table `_weight_class_description` */

insert  into `_weight_class_description`(`weight_class_id`,`language_id`,`title`,`unit`) values (1,1,'Kilogram','kg'),(2,1,'Gram','g'),(5,1,'Pound ','lb'),(6,1,'Ounce','oz'),(1,2,'Kilogram','kg'),(2,2,'Gram','g'),(5,2,'Pound ','lb'),(6,2,'Ounce','oz');
...
/*Data for the table `_zone_to_geo_zone` */

insert  into `_zone_to_geo_zone`(`zone_to_geo_zone_id`,`country_id`,`zone_id`,`geo_zone_id`,`date_added`,`date_modified`) values (57,222,0,3,'2010-02-26 22:33:24','0000-00-00 00:00:00'),(65,222,0,4,'2010-12-15 15:18:13','0000-00-00 00:00:00');
